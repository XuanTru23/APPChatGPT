...
import com.example.chatgpt.Models.MessageAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    void callAPI(String question) {
        // okhttp
        messageList.add(new Message("Vui lòng chờ...", Message.SEND_BY_BOT));
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                addResponse("Không thể tải phản hồi do lỗi " + e.getMessage());
            }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    addResponse("Không thể tải phản hồi do lỗi " + response.body().toString());
                }
